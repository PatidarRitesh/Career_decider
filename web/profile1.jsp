<%-- 
    Document   : profile1
    Created on : Oct 13, 2019, 8:23:18 PM
        ...
        <div class="container text-center">
            <div class="pricing-table pricing-table-highlighted">
                                        ...
                                        <div class="pricing-table-features">
                                             <p><strong>Name: &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp    <%=username%></strong></p>
                                             <p><strong>Email: &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp    <%=email%></strong></p>
                                             <p><strong>Mobile: &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  <%=mobile%></strong></p>
                                             <p><strong>Branch: &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  <%=stream%></strong></p>
                                             </div>
                                    </div>
                                </div>
        </div>
