...
<body class="seo_version">
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right menu-top">
                        ...
                        <li><a class="active" href="commerce.html"> Commerce </a></li>
    ...
    String query="select * from courses where Course_type='com'";
...
%>
       <div class="all-page-title" style="background-image:url(images/pattern-4.png);">
           ...
           <p><strong>Course Name <%=Course_name%></strong><br>Duration<%=Course_duration%></p>
                                            <p><strong><%=Course_url%></strong></p>
                                        </div>
                                    </div>
                                </div>
